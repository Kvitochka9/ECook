          ...
          return Card(
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  Container(height: 250,child: Image.network(posterUrl,width: double.infinity, fit: BoxFit.contain)),
                  SizedBox(height: 8),
                  Row(
                    ...
                    children: [
                      Text(
                        name,
                        style: TextStyle(fontSize: 35, fontWeight: FontWeight.bold, fontFamily: 'Caveat-VariableFont_wght'),
                      ),
